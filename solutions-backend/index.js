...
mongoose.connect("mongodb+srv://venkateshis20:venki@cluster0.fmf3ril.mongodb.net/?retryWrites=true&w=majority",(err)=>{
    if(err){
        console.log(err);
    }
    else{
...
app.use("/api/monetory",require("./routes/monetory"));
